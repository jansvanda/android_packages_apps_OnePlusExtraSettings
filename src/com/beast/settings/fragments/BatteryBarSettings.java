...
OnPreferenceChangeListener {
    ...
    public void onCreate(Bundle icicle) {
        ...
        addPreferencesFromResource(R.xml.beast_settings_batterybar);
        ...
        mBatteryBar.setValue((Settings.System.getInt(getActivity().getContentResolver(), Settings.System.BATTERY_BAR_LOCATION, 0)) + "");
        ...
        mBatteryBarUseGradient.setChecked(Settings.System.getInt(getActivity().getContentResolver(),
    ...
    public boolean onPreferenceChange(Preference preference, Object objValue) {
        ...
        if (preference == mBatteryBarColor) {
            ...
            Settings.System.putInt(getActivity().getContentResolver(), Settings.System.BATTERY_BAR_LOCATION, val);
    ...
    public boolean onPreferenceTreeClick(Preference preference) {
		...
		Settings.System.BATTERY_BAR_ANIMATE, value ? 1 : 0);
            ...
            Settings.System.putInt(getActivity().getContentResolver(), Settings.System.BATTERY_BAR_USE_GRADIENT_COLOR, value ? 1 : 0);
            return true;
        }
        return false;
    }

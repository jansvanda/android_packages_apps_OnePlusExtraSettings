...
package com.beast.settings.preferences;
...
import com.beast.settings.preferences.ShortcutPickHelper;
import com.beast.settings.preferences.ActionPreference;
import com.beast.settings.preferences.CustomActionListAdapter;
...
public class ActionFragment extends SettingsPreferenceFragment implements
    ...
    public int getDialogMetricsCategory(int dialogId) {
        switch (dialogId) {
            case DIALOG_CATEGORY:
            case DIALOG_CUSTOM_ACTIONS:
                return MetricsEvent.BEAST_SETTINGS;
            default:
                return 0;
        }
    }
